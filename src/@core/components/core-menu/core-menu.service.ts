...
export class CoreMenuService {
   ...
   */
  constructor(private _router: Router,  private _userProfileService: UserProfileService,) {
    this._userProfileService.currentUserSubject.subscribe(x => (this.currentUser = x));
